...
<body>
    ...
    <div class="sidebar-menu">
        <ul class="menu">
            ...
            <li
                ...
                <ul class="submenu ">
                    ...
                    <li class="submenu-item  ">
                         <a href="{{ route('form.buku') }}" class="submenu-link"><span>Data Buku</span></a> 
                ...
                @endif
                <li class="submenu-item  ">
                    <a href="{{ route('data.buku')}}" class="submenu-link"><span>Buku - Buku Islamic</span></a>
            ...
            @if (auth()->user() && auth()->user()->role !== 'user') 
            <li
            class="sidebar-item han-sub ">
            <a href="{{ route('grafik.buku')}}" class='sidebar-link'>
                <i class="bi bi-bar-chart-line-fill"></i>
                <span>Grafik User</span>
            </a>
            ...
            <li
            class="sidebar-item han-sub ">
            <a href="{{ route('favorit') }}" class='sidebar-link'>
                <i class="bi bi-star-fill"></i>
                <span>Lihat Daftar Favorit</span>
            </a>
    ...
    <div class="footer clearfix mb-0 text-muted">
        ...
        <div class="float-end">
            <p>Crafted with <span class="text-danger"><i class="bi bi-heart-fill icon-mid"></i></span>
                by <a href="https://saugi.me">Rifqi</a></p>
        </div>
    </div>
</footer>
        </div>
